...
tag @s add this
execute as @e[type=area_effect_cloud,tag=HologramCollider,distance=..30] if score @s HologramID = @a[tag=this,distance=..0,limit=1] HologramID at @s run function hologram_ui:core/cursor/particle
tag @s remove this
